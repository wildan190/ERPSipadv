              ...
              <div class="active tab-pane" id="personal_info">
                <form class="form-horizontal" method="POST" action="{{ route('adminUpdateInfo') }}" id="AdminInfoForm">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputDomain" placeholder="Domain" value="{{ Auth::user()->domain }}" name="domain">
                      <span class="text-danger error-text domain_error"></span>
                    </div>
                  </div>
                  <div class="form-group row">
