  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="{{ \URL::to('/')}}" class="brand-link">
        <img src="dist/img/co_logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-10" style="opacity: .9">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-compact nav-child-indent nav-collapse-hide-child nav-flat" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{ route('invoice.index')}}" class="nav-link {{ (request()->is('invoice/index*')) ? 'active' : '' }}">
                <i class="nav-icon fas fa-user-circle"></i>
                <p>
                  Invoice
                </p>
            ...
            <li class="nav-item">
              <a href="{{ route('product.create')}}" class="nav-link {{ (request()->is('invoice/index*')) ? 'active' : '' }}">
                <i class="nav-icon fas fa-user-circle"></i>
                <p>
                  Create Product
                </p>
            ...
            <!--<li class="nav-item">
              <a href="{{ route('addnew.index')}}" class="nav-link {{ (request()->is('addnew/index*')) ? 'active' : '' }}">
                <i class="nav-icon fas fa-user"></i>
                <p>
                  Add New User
                </p>
